...
- Docker Hub: `pickit420/reactive-resume:latest`
- GitHub Container Registry: `ghcr.io/lazy-media/reactive-resume:latest`
...
SMTP_USER=""
SMTP_PASS=""
SMTP_FROM="Reactive Resume <noreply@rxresume.org>"
SMTP_SECURE="false"
...
services:
  ...
  app:
    ...
    # image: ghcr.io/lazy-media/reactive-resume:latest
    restart: unless-stopped
    ports:
      - "3000:3000"
    env_file:
...
```
    ...
    <Tip>
      Prefer pulling from Docker Hub? Keep <code>pickit420/reactive-resume:latest</code>. Prefer GHCR? Swap it to <code>ghcr.io/lazy-media/reactive-resume:latest</code>.
    </Tip>
  </Step>
