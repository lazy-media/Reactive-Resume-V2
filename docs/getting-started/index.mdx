...
<AccordionGroup>
  <Accordion title="Completely Free & Open Source" icon="code-branch">
    Reactive Resume is licensed under MIT. You can use it for free, modify it, and even host your own instance. The entire codebase is available on [GitHub](https://github.com/lazy-media/reactive-resume).
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/lazy-media/reactive-resume">
  ...
  <Card title="Sponsor" icon="heart" href="https://github.com/sponsors/lazy-media">
    Support the development and long-term sustainability of Reactive Resume.
  </Card>
</CardGroup>

<Note>
  **Need help?** Feel free to reach out via [email](mailto:info@lazymedia.media) or open an issue on GitHub.
</Note>
