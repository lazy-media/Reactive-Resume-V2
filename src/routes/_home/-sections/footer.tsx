...
const getResourceLinks = (): FooterLinkItem[] => [
	...
	{ url: "https://github.com/lazy-media/reactive-resume", label: t`Source Code` },
	{ url: "https://crowdin.com/project/lazymedia-reactive-resume", label: t`Translations` },
	{ url: "https://github.com/sponsors/lazy-media", label: t`Donate` },
];

const getCommunityLinks = (): FooterLinkItem[] => [
	{ url: "https://github.com/lazy-media/reactive-resume/discussions", label: t`Discussions` },
	{ url: "https://github.com/lazy-media/reactive-resume/issues", label: t`Report an Issue` },
	{ url: "https://crowdin.com/project/lazymedia-reactive-resume", label: t`Translations` },
	{ url: "https://github.com/lazy-media/reactive-resume/blob/main/CONTRIBUTING.md", label: t`Contributing` },
];

const socialLinks: SocialLink[] = [
	{ url: "https://github.com/lazy-media/reactive-resume", label: "GitHub", icon: GithubLogoIcon },
	{ url: "https://social.lazymedia.media/@LazyMedia", label: "Mastodon", icon: LinkedinLogoIcon },
	{
