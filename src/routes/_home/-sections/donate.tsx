		...
		<div className="container relative px-8">
			...
			>
				<Button asChild size="lg" className="h-11 gap-2 px-6">
					<a href="https://github.com/sponsors/lazy-media" target="_blank" rel="noopener noreferrer">
				...
				<Button asChild size="lg" className="h-11 gap-2 px-6">
					<a href="https://coff.ee/lazymedia" target="_blank" rel="noopener noreferrer">
				...
				<Button asChild size="lg" className="h-11 gap-2 px-6">
					<a href="https://www.patreon.com/LazyMedia" target="_blank" rel="noopener noreferrer">
						<HeartIcon aria-hidden="true" weight="fill" className="text-orange-400 dark:text-orange-600" />
						Patreon
						<span className="sr-only"> ({t`opens in new tab`})</span>
					</a>
				</Button>
				...
				<Button asChild size="lg" className="h-11 gap-2 px-6">
					<a href="https://paypal.me/lazymediawa" target="_blank" rel="noopener noreferrer">
						<HeartIcon aria-hidden="true" weight="fill" className="text-blue-500 dark:text-blue-700" />
						PayPal
						<span className="sr-only"> ({t`opens in new tab`})</span>
					</a>
				</Button>
				...
				<Button asChild size="lg" className="h-11 gap-2 px-6">
					<a href="https://venmo.com/lazymedia" target="_blank" rel="noopener noreferrer">
